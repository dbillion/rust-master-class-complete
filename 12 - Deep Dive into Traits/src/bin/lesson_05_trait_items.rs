...
// just explain that the function used inside the block are function while the function inside the blockchain are methods therefore the syntax are difference for calling each of them
